    ...
    return (
        <>
            <header className="sticky-top">
                ...
                {location.pathname == "/" && (
                    <div className="nav-bar-wrapper flex flex-wrap gap-3 justify-start">
                        <div className="items">filter by {"->"}</div>
                        <div className="items" onClick={() => noFilter()}>
                            No filter
                        </div>
                        ...
                        <div className="items" onClick={() => filterBtPrice("29999")}>
                            {">="}29999
                        </div>
                        <div className="items" onClick={() => filterBtPrice("49999")}>
                            {">="}49999
                        </div>
                        <div className="items" onClick={() => filterBtPrice("69999")}>
                            {">="}69999
                        </div>
                        <div className="items" onClick={() => filterBtPrice("89999")}>
                            {">="}89999
                        </div>
                    </div>
                )}
